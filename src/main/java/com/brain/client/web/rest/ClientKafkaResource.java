...
@RestController
@RequestMapping("/api/client-kafka")
public class ClientKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ClientKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ClientKafkaResource(KafkaProperties kafkaProperties) {
